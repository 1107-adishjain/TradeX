...
import (
	...
	notifierapp "github.com/adishjain1107/tradex/pkg/notifier/app"
	"github.com/adishjain1107/tradex/pkg/notifier/config"
	api "github.com/adishjain1107/tradex/pkg/notifier/routes"
)
...
func main() {
	...
	application := notifierapp.New(cfg)

	router := api.Routes(application)

	srv := &http.Server{
		Addr:         ":" + cfg.NotifierPort,
		Handler:      router,
	...
	log.Printf("Starting server on port %s", cfg.NotifierPort)
